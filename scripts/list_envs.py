...
All the environments are registered in the `humanoid_rush` extension. They start
...
import humanoid_rush.tasks  # noqa: F401


def main():
    """Print all environments registered in `humanoid_rush` extension."""
